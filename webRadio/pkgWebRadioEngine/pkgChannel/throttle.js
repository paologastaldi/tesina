...
Throttle.prototype._onchunk = function (output, done) {
  ...
  */
  ...
  13/03/2016
  */
  //console.log("total seconds: " + totalSeconds + ", total bytes: " + this.totalBytes + ", expected: " + expected);
...
Throttle.prototype.start = function(){
  if(this.isPaused()){
    //console.log("sync paused: " + this.isPaused());
    this.startTime = null;
    this.resume();
  }
  //console.log("resumed: " + !this.isPaused());
};
